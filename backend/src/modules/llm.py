...
def context_prompt(history, context, query_text):
    ...
    Ответ должен быть четки и короткий. Не нужно лишних слов и воды.
    Если в представленном контексте нет нужной информации, отвечай что в твоей базе данных нет информации по этой теме и не давай никаких советов.
