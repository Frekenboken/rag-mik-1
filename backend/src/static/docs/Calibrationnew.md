...
1. Установить эталон Ø50 мм  
2. Нажать [Измерить эталон]  
3. Ввести реальное значение: 50.00 мм  
4. Повторить для эталона Ø100 мм  
5. Проверить линейность: R² > 0.9999

1. **Установить эталон Ø50 мм**: Поместить в измерительную зону цилиндрический эталон с диаметром 50.00 мм.  
...
4. **Повторить для эталона Ø100 мм**: Повторение процедуры с эталоном, расположенным в другой части рабочего диапазона (100.00 мм), позволяет определить коэффициент масштабирования и скорректировать нелинейность.  
...
| :---- | :---- | :---- |
| Ø25 мм | плюс-минус 0.1 мм | Повторить калибровку |
| Ø50 мм | плюс-минус 0.1 мм | Проверить фокус |
| Ø100 мм | плюс-минус 0.1 мм | Заменить датчик |
| Ø150 мм | плюс-минус 0.1 мм | Вызвать сервис |
